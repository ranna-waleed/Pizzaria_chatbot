...
def tokenization():
    for intent in intents['intents']:
        ...
        for pattern in intent['patterns']:
            ...
            # tokenize the patter using the function in the nltk_utils.py file
            w = tokenize(pattern)
...
# preparation of the training data from the the extracted data of intents.json file
def prepare_data():
...
class ChatDataset(Dataset):
    ...
    # introducing inde to the __getitem__ method to get the index of the elements in x_data and y_data
